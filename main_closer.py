...
from src.Tasks.DropWordsOneDimCloser import DropWordsOneDimCloser
from src.Tasks.SwapWordsOneDimCloser import SwapWordsOneDimCloser
...
if __name__ == "__main__":
    ...
    tasks: list = [
        (DropWordsOneDimCloser, ),
        (SwapWordsOneDimCloser, )]
